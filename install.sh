#!/usr/bin/env sh
# Universal installer for cloud-setups. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cloud-setups.git"
echo "Installing cloud-setups ..."
...
echo "Done. Run: cloud-setups --help"
